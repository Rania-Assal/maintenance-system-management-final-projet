    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white shadow-lg rounded-2xl p-6 text-center hover:scale-105 transition">
                ...
                <h3 class="text-xl font-bold text-gray-800">Plumber</h3>
            ...
            <div class="bg-white shadow-lg rounded-2xl p-6 text-center hover:scale-105 transition">
                <div class="text-5xl mb-4">🪚</div>
                <h3 class="text-xl font-bold text-gray-800">Carpenter</h3>
                <p class="mt-2 text-gray-600 text-sm">
            ...
            <div class="bg-white shadow-lg rounded-2xl p-6 text-center hover:scale-105 transition">
                ...
                <h3 class="text-xl font-bold text-gray-800">Refrigeration Technician</h3>
                <p class="mt-2 text-gray-600 text-sm">
            ...
            <div class="bg-white shadow-lg rounded-2xl p-6 text-center hover:scale-105 transition">
                <div class="text-5xl mb-4">🔥</div>
                <h3 class="text-xl font-bold text-gray-800">Oven Manufacturer</h3>
                <p class="mt-2 text-gray-600 text-sm">
